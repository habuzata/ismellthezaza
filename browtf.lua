...
local library = {
    ...
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'chinahack';
...
library.themes = {
    {
        ...
        theme = {
            ...
            ['Group Background']          = fromrgb(25,25,25);
            ...
            ['Section Background']        = fromrgb(15,15,15);
            ...
            ['Option Background']         = fromrgb(25,25,25);
